...
(function (flowchart) {
    ...
    (function (shape) {
        var ShapeBase = (function (_super) {
            ...
            ShapeBase.prototype.SetCssBackgroundClass = function (className) {
                    ...
                    for (var _i = 0, _a = _this.SelectedElements; _i < _a.length; _i++) {
                        ...
                        if (element instanceof flowchart.connection.ShapeConnection) {
                            ...
                            for (var _b = 0, _c = s.Connections; _b < _c.length; _b++) {
                                c = _c[_b];
                                var found = false;
                                for (var _d = 0, connections_2 = connections; _d < connections_2.length; _d++) {
                                    var tmpConnection = connections_2[_d];
